...
export const DS = {
  ...
  colors: {
    primary:'#3B82F6', primaryDk:'#2563EB', primaryLt:'#EFF6FF', primaryBd:'#BFDBFE',
    secondary:'#6366F1', secondaryDk:'#4338CA', secondaryLt:'#EEF2FF', secondaryBd:'#C7D2FE',
    success:'#10B981', successDk:'#059669', successLt:'#ECFDF5', successBd:'#A7F3D0',
    warning:'#F59E0B', warningDk:'#D97706', warningLt:'#FFFBEB', warningBd:'#FDE68A',
    danger:'#EF4444', dangerDk:'#DC2626', dangerLt:'#FEF2F2', dangerBd:'#FECACA',
    neutral:'#64748B', neutralDk:'#334155', neutralLt:'#F8FAFC', neutralBd:'#E2E8F0',
    surface:'#FFFFFF', bg:'#F1F5F9', overlay:'rgba(0,0,0,0.5)',
  },
  ...
  zIndex: { base:1, sticky:100, float:200, modal:300, toast:400, top:500 },
};
...
export const ANIMATIONS_CSS = `
  ...
  .vx-fadeUp     { animation: vx-fadeUp     300ms cubic-bezier(0.4,0,0.2,1) both; }
  .vx-fadeDown   { animation: vx-fadeDown   300ms cubic-bezier(0.4,0,0.2,1) both; }
  .vx-slideRight { animation: vx-slideRight 300ms cubic-bezier(0.4,0,0.2,1) both; }
  .vx-popup      { animation: vx-popup      400ms cubic-bezier(0.34,1.56,0.64,1) both; }

  /* FIX: classe .vx-pulse était manquante dans l'original */
  .vx-pulse { animation: vx-pulse 2s infinite; }
